...
$routes->get('/blog-categories', 'Api::blogCategories', ['as' => 'blog-categories.json']);
...
$routes->get('/trends/(:any)', 'Api::trends/$1', ['as' => 'trends_country.json']);
...
$routes->get('/twitter_api/(:any)', 'Api::twitter_api/$1', ['as' => 'twitter_country.json']);
...
//$routes->set404Override('App\Controllers\Page::show404');

$routes->set404Override(function ()
{
    echo view('Frontend/Pages/show404');
});
