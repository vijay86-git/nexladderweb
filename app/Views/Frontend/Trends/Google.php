         ...
         <div class="">
            <div class="row">
               <div class="col-md-3">
                   ...
                   <p class="st"><a title="Home" href='<?php echo route_to('/') ?>'><i class="fa fa-home">&nbsp;</i></a>&raquo;&nbsp;<a title="Google Trends" href="<?= route_to('gogole_trends') ?>">Google Trends</a> &raquo;&nbsp;India United states of america</p>
