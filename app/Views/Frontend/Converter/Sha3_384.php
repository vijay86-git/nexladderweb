               ...
               <div class="col-md-9">
                  ...
                  <div class="row mrgnbtm35 containter_tools">
                     <div class="col-md-12">
                     	...
                     	<div class="row">
                     	   <div class="col-md-12">
                     	   	<h1 class="heading">SHA3-384 Hash Generator</h1>
                     	   </div>
                     	</div>
                     	...
                     	<div class="row mrgnbtm15">
                     		<div class="col-md-12">
                     	  		<textarea placeholder="Enter Text to Generate SHA3-384 Hash" name="inputTextArea" id="inputTextArea" class="form-control-cls"></textarea>
                     	  	</div>
                     	</div>
                        ...
                        <div class="row mrgnbtm15">
                           <div class="col-md-12">
                                 <textarea readonly="" placeholder="Generated SHA3-384 Hash" name="outputTextArea" id="outputTextArea" class="form-control-cls"></textarea>
                              </div>
                        </div>
         ...
         function generate()
          {
             ...
             $("#outputTextArea").val(sha3_384(inputTextArea));
          }
