               ...
               <div class="col-md-9">
                  ...
                  <div class="row mrgnbtm35 containter_tools">
                     <div class="col-md-12">
                     	...
                     	<div class="row">
                     	   <div class="col-md-12">
                     	   	<h1 class="heading">MD5 Hash Generator</h1>
                     	   </div>
                     	</div>
                     	...
                     	<div class="row">
                     	   	<div class="col-md-6">
                     	         <h3>Result of MD5 Generated Hash:</h3>
                     	      </div>
                     	...
                     	<div class="row mrgnbtm15">
                     		<div class="col-md-12">
                     	   		<textarea readonly="" placeholder="Generated MD5 Hash" name="outputTextArea" id="outputTextArea" class="form-control-cls"></textarea>
                     	   	</div>
                     	</div>
         ...
         function generate()
           {
              ...
              let generateMd2   = md5(inputTextArea);
