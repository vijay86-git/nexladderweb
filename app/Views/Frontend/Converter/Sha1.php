...
<style>
 ...
 .form-control-cls{width:100%;height:150px;border:1px solid #ddd;padding:15px;border-radius:5px;}
 ...
 h3{font-weight:bold}
               ...
               <div class="col-md-9">
                  ...
                  <div class="row mrgnbtm35 containter_tools">
                     <div class="col-md-12">
                     	...
                     	<div class="row">
                     	   <div class="col-md-12">
                     	   	<h1 class="heading">SHA1 Hash Generator</h1>
                     	   </div>
                     	</div>
                     	...
                     	<div class="row mrgnbtm15">
                     		<div class="col-md-12">
                     	  		<textarea placeholder="Enter Text to Generate Hash" name="inputTextArea" id="inputTextArea" class="form-control-cls"></textarea>
                     	  	</div>
                     	</div>
                     	...
                     	<div class="row">
                     	   	<div class="col-md-6">
                     	         <h3>Result of SHA1 Generated Hash:</h3>
                     	      </div>

                     	      <div class="col-md-6 icons text-right">
                     	      	  <span class="opt upper_case">Upper Case (a <i class="fa fa-long-arrow-right"></i> A)</span>
                     	      	  <span class="opt lower_case">Lower Case (A <i class="fa fa-long-arrow-right"></i> a)</span>
                     	      	  <span class="copyOutput" title="Copy to Clipboard"><i class="fa fa-clone">&nbsp;</i></span>
                     	...
                     	<div class="row mrgnbtm15">
                     		<div class="col-md-12">
                     	   		<textarea readonly="" placeholder="Generated SHA1 Hash" name="outputTextArea" id="outputTextArea" class="form-control-cls"></textarea>
                     	   	</div>
                     	</div>
      ...
      <script src="<?php echo loadAssetsFiles('build/assets/js/md5.min.js?v=1.0'); ?>"></script>
      <script src="<?php echo loadAssetsFiles('build/assets/js/common.js?v=1.0'); ?>"></script>
      <script>
         function generate()
           {
              let inputTextArea = $("#inputTextArea").val();
              let generateMd2   = sha1(inputTextArea);
              $("#outputTextArea").val(generateMd2);
           }
      </script>
