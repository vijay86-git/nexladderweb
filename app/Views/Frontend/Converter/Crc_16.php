...
.padtp15{padding-top:15px}
               ...
               <div class="col-md-9">
                  ...
                  <div class="row mrgnbtm35 containter_tools">
                     <div class="col-md-12">
                     	...
                     	<div class="row">
                     	   <div class="col-md-12">
                     	   	<h1 class="heading">CRC-16 Hash Generator</h1>
                     	   </div>
                     	</div>
                     	...
                     	<div class="row mrgnbtm15">
                     		<div class="col-md-12">
                     	  		<textarea placeholder="Enter Text to Generate CRC-16 Hash" name="inputTextArea" id="inputTextArea" class="form-control-cls"></textarea>
                     	  	</div>
                     	</div>
                        ...
                        <div class="row mrgnbtm15">
                           <div class="col-md-12">
                                 <textarea readonly="" placeholder="Generated CRC-16 Hash" name="outputTextArea" id="outputTextArea" class="form-control-cls"></textarea>
                              </div>
                        </div>
      ...
      <script src="<?php echo loadAssetsFiles('build/assets/js/crc.min.js?v=1.0'); ?>"></script>
         ...
         function generate()
          {
             ...
             $("#outputTextArea").val(crc16(inputTextArea));
          }
