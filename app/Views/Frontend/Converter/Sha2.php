...
.padtp15{padding-top:15px}
               ...
               <div class="col-md-9">
                  ...
                  <div class="row mrgnbtm35 containter_tools">
                     <div class="col-md-12">
                     	...
                     	<div class="row">
                     	   <div class="col-md-12">
                     	   	<h1 class="heading">SHA-2 Hash Generator</h1>
                     	   </div>
                     	</div>
                     	...
                     	<div class="row mrgnbtm15">
                     		<div class="col-md-12">
                     	  		<textarea placeholder="Enter Text to Generate SHA2 Hash" name="inputTextArea" id="inputTextArea" class="form-control-cls"></textarea>
                     	  	</div>
                     	</div>
                        ...
                        <div class="row margintp15">
                              ...
                              <div class="col-md-9 icons text-right">
                                   <textarea readonly="" placeholder="SHA2-224 Result" name="outputTextArea1" id="outputTextArea1" class="form-control-cls"></textarea>
                              </div>
                              ...
                              <div class="col-md-2 icons text-right lnehght">
                                   ...
                                   <span class="" title="">56 length</span>
                              </div>
                        ...
                        <div class="row margintp15">
                              ...
                              <div class="col-md-9 icons text-right">
                                   <textarea readonly="" placeholder="SHA2-256 Result" name="outputTextArea2" id="outputTextArea2" class="form-control-cls"></textarea>
                              </div>
                        ...
                        <div class="row margintp15">
                              ...
                              <div class="col-md-9 icons text-right">
                                   <textarea readonly="" placeholder="SHA2-384 Result" name="outputTextArea3" id="outputTextArea3" class="form-control-cls"></textarea>
                              </div>

                              <div class="col-md-2 icons text-right lnehght">
                                   <span class="copyOutput" data-attr="3" title="Copy to Clipboard"><i class="fa fa-clone">&nbsp;</i></span>
                                   <span class="" title="">96 length</span>
                              </div>
                        ...
                        <div class="row margintp15">
                              ...
                              <div class="col-md-9 icons text-right">
                                   <textarea readonly="" placeholder="SHA2-512 Result" name="outputTextArea4" id="outputTextArea4" class="form-control-cls"></textarea>
                              </div>

                              <div class="col-md-2 icons text-right lnehght">
                                   <span class="copyOutput" data-attr="4" title="Copy to Clipboard"><i class="fa fa-clone">&nbsp;</i></span>
                        ...
                        <div class="row margintp15">
                              ...
                              <div class="col-md-9 icons text-right">
                                   <textarea readonly="" placeholder="SHA2-512/224 Result" name="outputTextArea5" id="outputTextArea5" class="form-control-cls"></textarea>
                              </div>

                              <div class="col-md-2 icons text-right lnehght">
                                   <span class="copyOutput" data-attr="5" title="Copy to Clipboard"><i class="fa fa-clone">&nbsp;</i></span>
                                   <span class="" title="">56 length</span>
                              </div>
                        ...
                        <div class="row margintp15">
                              ...
                              <div class="col-md-9 icons text-right">
                                   <textarea readonly="" placeholder="SHA2-512/256 Result" name="outputTextArea6" id="outputTextArea6" class="form-control-cls"></textarea>
                              </div>

                              <div class="col-md-2 icons text-right lnehght">
                                   <span class="copyOutput" data-attr="6" title="Copy to Clipboard"><i class="fa fa-clone">&nbsp;</i></span>
                                   <span class="" title="">64 length</span>
                              </div>
      ...
      <script src="<?php echo loadAssetsFiles('build/assets/js/sha256.min.js?v=1.0'); ?>"></script>
         ...
         function generate()
          {
             ...
             $("#outputTextArea1").val(sha224(inputTextArea));
             $("#outputTextArea2").val(sha256(inputTextArea));
             $("#outputTextArea3").val(sha384(inputTextArea));
             $("#outputTextArea4").val(sha512(inputTextArea));
             $("#outputTextArea5").val(sha512_224(inputTextArea));
             $("#outputTextArea6").val(sha512_256(inputTextArea));
          }
