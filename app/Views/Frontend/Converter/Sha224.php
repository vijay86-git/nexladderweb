               ...
               <div class="col-md-9">
                  ...
                  <div class="row mrgnbtm35 containter_tools">
                     <div class="col-md-12">
                     	...
                     	<div class="row">
                     	   <div class="col-md-12">
                     	   	<h1 class="heading">SHA-224 Hash Generator</h1>
                     	   </div>
                     	</div>
                     	...
                     	<div class="row mrgnbtm15">
                     		<div class="col-md-12">
                     	  		<textarea placeholder="Enter Text to Generate SHA-224 Hash" name="inputTextArea" id="inputTextArea" class="form-control-cls"></textarea>
                     	  	</div>
                     	</div>
                        ...
                        <div class="row mrgnbtm15">
                           <div class="col-md-12">
                                 <textarea readonly="" placeholder="Generated SHA-224 Hash" name="outputTextArea" id="outputTextArea" class="form-control-cls"></textarea>
                              </div>
                        </div>
         ...
         function generate()
          {
             ...
             $("#outputTextArea").val(sha224(inputTextArea));
          }
