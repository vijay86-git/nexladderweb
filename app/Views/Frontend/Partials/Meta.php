	 <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
      ...
      <link rel="stylesheet" href="<?php echo loadAssetsFiles('build/assets/css/font-awesome.css?v=1.2'); ?>" />
      <link rel="stylesheet" href="<?php echo loadAssetsFiles('build/assets/css/style.css?v=1.2'); ?>" />
      <style>
