	 <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
      ...
      <link rel="stylesheet" href="<?php echo loadAssetsFiles('build/assets/css/bootstrap.min.css?v=1.1'); ?>" />
      <link rel="stylesheet" href="<?php echo loadAssetsFiles('build/assets/css/font-awesome.css?v=1.1'); ?>" />
      <link rel="stylesheet" href="<?php echo loadAssetsFiles('build/assets/css/style.css?v=1.1'); ?>" />
      <style>
      ...
      <meta name="twitter:domain" content="https://nexladder.com" />
      <meta name="twitter:creator" content="nexladder.com" />
      <meta name="twitter:image" content="https://nexladder.com/images/nexsharelogo.png" />
