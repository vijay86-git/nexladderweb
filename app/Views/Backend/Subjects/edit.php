                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-title">
                            <a href="<?php echo route_to('admin.news.index'); ?>"><button class="btn btn-xs btn-info pull-left">&laquo; Back</button></a>&nbsp;<h5 class="padtp5">Update News</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <?php echo form_open_multipart(route_to('admin.news.update', $id), ['method' => 'post']); ?>
                                <?php echo csrf_field() ?>

                                <div class="form-group row"><label class="col-sm-2 col-form-label">Title <span class="req">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" value="<?php echo $news_arr['title']; ?>" class="form-control" name="title" autocomplete="off" />
                                         <?php 
                                            if (isset($validator))
                                ...
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Description <span class="req">*</span></label>
                                    <div class="col-sm-10">
                                        <textarea name="description" style="height:300px !important" class="desc"><?php echo $news_arr['description']; ?></textarea>
                                        <?php 
                                          if (isset($validator))
                                ...
                                <div class="form-group row"><label class="col-sm-2 col-form-label">Status <span class="req">*</span></label>
                                    <div class="col-sm-10">
                                        <input type="radio" value="1" <?php echo $news_arr['status'] == '1' ? "checked" : "" ?>  class="" name="status" autocomplete="off" />&nbsp;Active
                                        <input type="radio" value="0" <?php echo $news_arr['status'] == '0' ? "checked" : "" ?> class="" name="status" autocomplete="off" />&nbsp;Inactive
                                         <?php 
                                            if (isset($validator))
