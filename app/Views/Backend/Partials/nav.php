...
<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="<?php echo $dashboard_active ?: ""; ?>">
                <?php echo anchor(route_to('admin.dashboard.index'), '<span class="nav-label">Subjects</span>', ["class=''"]);?>
            </li>

            <li class="<?php echo $dashboard_active ?: ""; ?>">
                <?php echo anchor(route_to('admin.dashboard.index'), '<span class="nav-label">Sections</span>', ["class=''"]); ?>
            </li>

            <li class="<?php echo $dashboard_active ?: ""; ?>">
                <?php echo anchor(route_to('admin.dashboard.index'), '<span class="nav-label">Topics</span>', ["class=''"]); ?>
            </li>
