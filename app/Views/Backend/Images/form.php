                ...
                <div class="col-lg-12">
                    <div class="ibox ">
                        ...
                        <div class="ibox-title">
                            <a href="<?php echo route_to('admin.camp.index'); ?>"><button class="btn btn-xs btn-info pull-left">&laquo; Back</button></a>&nbsp;<h5 class="padtp5">Add Topic</h5>
                        ...
                        <div class="ibox-content">
                            ...
                            <?php echo form_open_multipart(route_to('admin.topic.create'), ['method' => 'post']); ?>
                                <?php echo csrf_field() ?>
                                            ...
                                            <?php 
                                              if (count($sections)):
                                                foreach ($sections as $section):
                                                  $selected = (set_value('subject') == $section->id) ? "selected" : "";
...
<script>
    ...
    function sel_subject(id)
     {
        const {origin} = window.location;
        let url = `${origin}/panel/topics/new?subject_id=${id}`;
        location.href = url;
     }
</script>
